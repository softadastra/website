# Softadastra Non-Goals

This document defines what Softadastra explicitly does **not** aim to be or solve.

Non-goals are as important as goals. They protect the foundation from dilution, misinterpretation, and short-term pressure.
...
- a replacement for React, Vue, or similar UI frameworks
- a UI toolkit or component library
- a design system
...
Softadastra is **not** a degraded version of the web.

It is:

- a more resilient architecture
- applicable to all environments
- beneficial even under ideal conditions
...
These non-goals define the boundaries of Softadastra.

They exist to ensure that the foundation remains focused, coherent, and resistant to erosion over time.

If something feels appealing but violates a non-goal, it must be rejected.
